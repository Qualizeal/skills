...
Validate · Measure · Improve — the loop that turns execution results into organisational learning.

| Agent | Model | Invoke for |
|---|---|---|
| `defect-reporter` | sonnet | Enriched defect reports with screening and RCA |
...
- Install: `/plugin install qa-governance@qz-agent-clusters`
