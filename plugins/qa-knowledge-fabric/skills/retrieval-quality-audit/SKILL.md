...
description: "Diagnose degraded retrieval by attributing failures to chunking, tagging, coverage, ranking or staleness, and review which workflows the corpus can actually answer. Use when retrieval quality is the complaint or during a quarterly coverage review."
---
