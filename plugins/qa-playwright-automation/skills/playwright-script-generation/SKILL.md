...
description: "The test-case-to-code translation contract, spec templates, data-driven and API-hybrid patterns, codegen rewriting, the review checklist and when not to automate. Use when turning designed test cases into committed Playwright specs."
---
