---
name: playwright-mcp
description: "Driving a real browser to explore, discover locators and reproduce defects — the snapshot loop, tool families, MCP versus CLI token cost, configuration and safety guardrails. Use when exploring a live application before writing a test."
---
