...
3. **Detect ambiguity.** Flag every instance of the categories in the `requirements-refinement` skill (weasel words, unquantified adjectives, missing actors, undefined states, implicit assumptions, dangling pronouns).
